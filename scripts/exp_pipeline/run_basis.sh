...
#--output_dir=test_sheng24_30 > test_sheng24_30/run_{}.log 2>&1" ::: "${VALUES[@]}"



python build_spherical_basis.py 108 halo --coefs_freq=1 --fit-type=median
--output_dir=./exp_coefficients/
